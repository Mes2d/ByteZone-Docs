    ...
    <div class="uk-section">
        ...
        <div class="uk-container uk-container-xsmall">
            ...
            <article class="uk-article">
                <h1 class="uk-article-title uk-text-center">{{ __('Edit Page') }}</h1>
                    ...
                    <form class="uk-form-stacked  uk-grid-small uk-margin-medium-top" uk-grid method="POST" enctype="multipart/form-data" action="{{ route('pages.update',$page) }}"
                        ...
                        <div class="uk-margin-medium-bottom uk-width-1-2@s">
                            ...
                            <div class="uk-form-controls">
                                <input id="name" class="uk-input  uk-border-rounded" name="title" type="text" value="{{ $page->title }}" required="">
                            </div>
                        ...
                        <div class="uk-margin-medium-bottom uk-width-1-2@s">
                            ...
                            <div class="uk-form-controls">
                                <input id="slug" class="uk-input  uk-border-rounded" name="slug" type="text" value="{{ $page->slug }}" required="">
                            </div>
                        ...
                        <div class="uk-margin-medium-bottom uk-width-1-1@s">
                            ...
                            <div class="uk-form-controls">
                                <textarea name="description" class="uk-textarea  uk-border-rounded" id="description" >{{$page->description}}</textarea>
                            </div>
                        ...
                        <div class="uk-margin-medium-bottom uk-width-1-2@s">
                            ...
                            <div class="uk-form-controls">
                                <input id="slug_ar" class="uk-input  uk-border-rounded" name="slug_ar" type="text" value="{{ $page->slug_ar }}" required="">
                            </div>
                        ...
                        <div class="uk-margin-medium-bottom uk-width-1-1@s">
                            ...
                            <div class="uk-form-controls">
                                <textarea name="description_ar" class="uk-textarea  uk-border-rounded" id="description_ar" >{{$page->description_ar}}</textarea>
                            </div>
